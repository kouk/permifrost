...
The owner field in the spec file for roles is now verified against what is in the database.  If there is a mismatch, permifrost will not present an error to the user describing that the role does not have the correct owner in the spec.
